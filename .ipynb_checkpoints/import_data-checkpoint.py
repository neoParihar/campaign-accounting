 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 6,
   "id": "f779526c-c655-48ba-a78e-00d606ba467a",
   "metadata": {},
   "outputs": [],
   "source": [
    "import pandas as pd\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 7,
   "id": "5fcc60aa-63fa-401d-9212-b7a5a5b308b6",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 11,
   "id": "2b6dd73b-8b74-4518-b937-d60b81700d20",
   "metadata": {},
   "outputs": [],
   "source": [
    "candidates = pd.read_csv(\"data/candidate_master.txt\", sep=\"|\", header=None, \n",
    "                         names=[\"cand_id\", \"cand_name\", \"cand_pty_affiliation\", \"cand_election_yr\", \n",
    "                                \"cand_office_st\", \"cand_office\", \"cand_office_district\", \"cand_ici\", \n",
    "                                \"cand_status\", \"cand_pcc\", \"cand_st1\", \"cand_st2\", \"cand_city\", \n",
    "                                \"cand_st\", \"cand_zip\"])\n",
    "candidate_db = candidates[[\"cand_id\", \"cand_name\", \"cand_pty_affiliation\", \"cand_election_yr\", \n",
    "                           \"cand_office_st\", \"cand_office\", \"cand_office_district\", \"cand_ici\", \n",
    "                           \"cand_status\", \"cand_pcc\"]]\n",
    "cand_data = [tuple(None if pd.isna(x) else x for x in row) for row in candidate_db.to_numpy()]"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "9c01fbbe-d9a2-4dba-9312-210826bb500c",
   "metadata": {},
   "outputs": [],
   "source": [
    "committees = pd.read_csv(\"data/committee_master26.txt\", sep=\"|\", header=None, \n",
    "                         names=[\"comm_id\", ])"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 9,
   "id": "16829740-e7d1-4e16-b9ca-ddf5e925a043",
   "metadata": {},
   "outputs": [],
   "source": [
    "cursor = conn.cursor()\n",
    ...
    "        \"\"\"\n",
    "cursor.executemany(cand_query, cand_data)\n",
    "conn.commit()"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 10,
   "id": "a40969e4-2e8f-4d06-9950-2a3062391233",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "aa46a0cf-7f34-4140-be2b-9473a31fe2ae",
   "metadata": {},
   "outputs": [],
   "source": []
  }
